...
def add_supply_to_memorial_day(holiday_hash, supply)
  ...
  # add the second argument (passed to the method) to the memorial day array
holiday_hash[:spring] [:memorial_day]<< supply

end

def add_new_holiday_with_supplies(holiday_hash, season, holiday_name, supply_array)
  # code here. Using method arguments, add a new holiday, season, and array of supplies to holiday_hash.
...
def all_holidays_with_bbq(holiday_hash)
  ...
  holiday_hash.map each do |season, holidays|
